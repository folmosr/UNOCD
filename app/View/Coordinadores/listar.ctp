              ...
              <?php 
				...
				<tr>
                    ...
                    <td valign="middle">
                 	...
                 	<td>
                       <div class="btn-group">
                      		<a href="<?php  if($data[$i]['Usuario']['status'])  echo '/unocdcom/coordinadores/editar/'.$this->CustomFunctions->encode($data[$i]['Usuario']['id']); else echo '#'; ?>" class="btn btn-circle <?php if($data[$i]['Usuario']['status']) echo 'btn-success'; ?>" title="Actualizar Datos de Usuario <?php if(!$data[$i]['Usuario']['status']) echo '- active al usuario para poder realizar esta acción sobre los datos del mismo'; ?>"><i class="icon-ok-sign"></i></a>                       
                            <a href="/unocdcom/coordinadores/q_on/<?php echo $this->CustomFunctions->encode($data[$i]['Usuario']['id']); ?>" class="btn btn-circle <?php  echo ($data[$i]['Usuario']['status'])?'btn-danger':'btn-success'; ?>" title="Desactivar Usuario"><i class="icon-user"></i></a>
                      </div>
                    </td>
                 </tr>
              <?php 
