...
echo $this->Html->script(
	...
	$this->Html->addCrumb('Editar datos de Administrador', '/administradores/editar/'.$usuario_id);
?>
...
<div class="row">
  <div class="col-md-12">
    <div class="box">
      <div class="box-title">
        <h3><i class="icon-table"></i> Datos de Administrador</h3>
      </div>
        ...
        <div class="table-responsive">
          <div class="scrollable-area">
            <?php
				...
				echo $this->Form->input('exportar', array(
